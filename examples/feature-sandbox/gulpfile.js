...
gulp.task('app', function () {
    return gulp.src(appFiles)
        .pipe(traceur({experimental: true, modules: 'instantiate', moduleName: true, annotations: true, types: true, typeAssertions: true, typeAssertionModule: "angular2/rtts-assert.js"}))
